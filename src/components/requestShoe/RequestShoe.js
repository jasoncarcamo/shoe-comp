...
export default class RequestShoe extends React.Component{
    ...
    handleAddToCart = ()=>{
        ...
        if(!TokenService.hasAuthToken()){
            return this.setState({ error: <span id="cart-error">You must <Link to="/login">log in</Link> to add items to your cart. Or you can register <Link to="/register">here.</Link></span>})
        }
